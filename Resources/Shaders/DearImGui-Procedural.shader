Shader "DearImGui/Procedural"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.tinygoose.dear-imgui/Resources/Shaders/PassesUniversal.hlsl"
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma vertex vert
            #pragma fragment ImGuiPassFrag
            #include "Packages/com.tinygoose.dear-imgui/Resources/Shaders/PassesBuiltin.hlsl"
